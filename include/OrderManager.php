<?php
class OrderManager {
  private static string $cfg_dir  = "/boot/config/plugins/fancontrolplus2";
  private static string $order_file = "/boot/config/plugins/fancontrolplus2/order.cfg";
  ...
  public static function replaceFileName($old_file, $new_file) {
        $cfg_dir = "/boot/config/plugins/fancontrolplus2"; // 路径可按你实际定义
